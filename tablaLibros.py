...
class TablaLibrosUI():
    ...
    def __init__(self, estructuraDatos):
        ...
        self.frame1.pack()
        lb_header = ['Titulo', 'Editorial', 'Año de publicacion', 'Genero', 'Edicion', 'Precio']
        #lb_list = [
...
#TablaLibrosUI()
#print(lb_list)
#TablaLibrosUI(basedatos.obtenerBaseDatosLibros("baseDatosLibros.txt"))
#print(lb_list)
#for x in lb_list:
#    print(x)

#lista = ["dracula", "porrua"]
#print(tuple(lista))
#lista = ["memo", 550]
